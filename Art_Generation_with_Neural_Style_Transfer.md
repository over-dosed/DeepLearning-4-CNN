...
```
    ...
    <tensorflow.python.keras.engine.functional.Functional object at 0x7f65f86c66d8>
...
```
    ...
    tf.Tensor(25629.105, shape=(), dtype=float32)
    tf.Tensor(17735.56, shape=(), dtype=float32)
    [92mAll tests passed
